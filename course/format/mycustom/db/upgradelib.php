...
/**
 * Upgrade scripts for course format "mycustom"
 *
...
/**
 * This method finds all courses in 'mycustom' format that have actual number of sections
 ...
 *
 */
function format_mycustom_upgrade_remove_numsections() {
    global $DB;
    ...
    $params = ['format1' => 'mycustom', 'format2' => 'mycustom', 'numsections' => 'numsections'];
    ...
    $DB->delete_records('course_format_options', ['format' => 'mycustom', 'sectionid' => 0, 'name' => 'numsections']);
}
