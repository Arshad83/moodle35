...
/**
 * Strings for component 'format_mycustom', language 'en'
 *
 * @since 2.4
...
$string['pluginname'] = 'mycustom  format';
$string['page-course-view-topics'] = 'Any course main page in mycustom format';
$string['page-course-view-topics-x'] = 'Any course page in mycustom format';
...
$string['privacy:metadata'] = 'The mycustom format plugin does not store any personal data.';
