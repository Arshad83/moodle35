...
/**
 * Specialised restore for format_mycustom
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_format_mycustom_plugin extends restore_format_topics_plugin {
    ...
    public function after_restore_course() {
        ...
        if ($backupinfo->original_course_format !== 'mycustom' || !isset($data['tags']['numsections'])) {
