@format @format_customtab
Feature: Sections can be edited and deleted in customtab format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete customtab
  ...
  @javascript
  Scenario: Inline edit section name in customtab format
  ...
  Scenario: Deleting the last section in customtab format
  ...
  Scenario: Deleting the middle section in customtab format
